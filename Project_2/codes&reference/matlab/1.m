...
for t = 1:hyperparameters.num_iterations
	...
	%% Print some stats.
	fprintf(1, 'ITERATION:%4i   NLOGL:%11.2f TRAIN_CE:%16.6f TRAIN_FRAC:%12.2f VALIC_CE:%16.6f VALID_FRAC:%12.2f\n%17sNLOGL_SMALL:%5.2f TRAIN_SMALL_CE:%10.6f TRAIN_SMALL_FRAC:%6.2f VALID_CE_SMALL:%10.6f VALID_FRAC_SMALL:%6.2f\n',...
...
l = legend('train', 'valid', 'Location', 'NorthEast');
set(l, 'FontSize', 12);
...
l = legend('train\_small', 'valid', 'Location', 'NorthEast');
set(l, 'FontSize', 12);
xlabel('Iteration', 'FontSize', 12);
ylabel('Cross entropy', 'FontSize', 12);
